...
public interface CacheSortedSetRemoveElementsResponse {

  /** A successful sorted set remove elements operation. */
  class Success implements CacheSortedSetRemoveElementsResponse {}
   ...
   */
  class Error extends SdkException implements CacheSortedSetRemoveElementsResponse {
