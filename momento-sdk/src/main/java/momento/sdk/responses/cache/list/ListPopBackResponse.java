...
public interface ListPopBackResponse {

  /** A successful list pop back operation that found elements. */
  class Hit implements ListPopBackResponse {
  ...
  class Miss implements ListPopBackResponse {}
   ...
   */
  class Error extends SdkException implements ListPopBackResponse {
