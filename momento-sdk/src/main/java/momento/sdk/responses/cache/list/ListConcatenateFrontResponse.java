 ...
 * <p>{Success}, {Error}
 */
public interface ListConcatenateFrontResponse {

  /** A successful list concatenate front operation. */
  class Success implements ListConcatenateFrontResponse {
   ...
   */
  class Error extends SdkException implements ListConcatenateFrontResponse {
