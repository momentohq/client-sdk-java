...
public class DisposableTokenScopes {
    ...
    public static DisposableTokenScope cacheReadWrite(CacheSelector cacheSelector) {
        return new DisposableTokenScope(Collections.singletonList(new DisposableToken.CacheItemPermission(
                CacheRole.ReadWrite,
                cacheSelector,
    ...
    public static DisposableTokenScope topicPublishSubscribe(CacheSelector cacheSelector, TopicSelector topicSelector) {
        return new DisposableTokenScope(Collections.singletonList(new DisposableToken.TopicPermission(
    ...
    public static DisposableTokenScope topicNamePrefixPublishSubscribe(String cacheName, String topicNamePrefix) {
        return topicNamePrefixPublishSubscribe(CacheSelector.ByName(cacheName),
    ...
    public static DisposableTokenScope topicNamePrefixSubscribeOnly(String cacheName, String topicNamePrefix) {
        return topicNamePrefixSubscribeOnly(CacheSelector.ByName(cacheName),
                TopicSelector.ByTopicNamePrefix(topicNamePrefix));
    }
    ...
    public static DisposableTokenScope topicNamePrefixPublishOnly(String cacheName, String topicNamePrefix) {
        return topicNamePrefixPublishOnly(CacheSelector.ByName(cacheName),
                TopicSelector.ByTopicNamePrefix(topicNamePrefix));
    }
