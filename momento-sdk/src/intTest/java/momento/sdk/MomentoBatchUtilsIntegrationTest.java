...
public class MomentoBatchUtilsIntegrationTest extends BaseTestClass {
    ...
    @BeforeEach
    void setup() {
        cacheClient =  CacheClient.builder(credentialProvider, Configurations.Laptop.latest(), Duration.ofSeconds(10))
                .build();
        cacheName = "batchTest";
    ...
    void testBatchGetWithStringKeys() throws ExecutionException, InterruptedException {
        ...
        BatchGetRequest.StringKeyBatchGetRequest request = new BatchGetRequest.StringKeyBatchGetRequest(Arrays.asList(key1, key2));
        ...
        List<BatchGetResponse.BatchGetSummary.GetSummary> summaries = ((BatchGetResponse.BatchGetSummary) response).getSummaries();
    ...
    void testBatchGetWithByteArrayKeys() throws ExecutionException, InterruptedException {
        ...
        // Create a batch get request
        BatchGetRequest.ByteArrayKeyBatchGetRequest request = new BatchGetRequest.ByteArrayKeyBatchGetRequest(Arrays.asList(key1, key2));
        ...
        for (BatchGetResponse.BatchGetSummary.GetSummary summary : summaries) {
            ...
            assertThat(key).isIn(new String(key1, StandardCharsets.UTF_8),
                    new String(key2, StandardCharsets.UTF_8));
    ...
    @Test
    void testBatchGetWithStringKeys_MoreThanMaxConcurrentThrows() throws ExecutionException, InterruptedException {
        MomentoBatchUtils momentoBatchUtils = MomentoBatchUtils.builder(cacheClient)
        ...
        assertThat((((BatchGetResponse.Error) response)).getMessage()).isEqualTo(
