...
public class DocExamplesJavaAPIs {
  ...
  public static void example_API_Storage_Get(PreviewStorageClient storageClient) {
    ...
    // simplified style to access the value, if you're confident the value exists and you know the type.
    ...
    if (response instanceof GetResponse.Found found) {
      ...
      String stringValue = found.value().getString().orElseThrow(() -> new RuntimeException("Value was not a String!"));
      ...
      switch (found.value().getType()) {
        ...
        case BYTE_ARRAY -> System.out.println("Byte array value: " + found.value().getByteArray().get());
